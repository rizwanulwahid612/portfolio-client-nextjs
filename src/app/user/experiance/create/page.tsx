...
import { useAddExperianceDataMutation } from "@/redux/api/experianceApi";
...
useEffect(()=>{
  ...
  const [addExperianceData] = useAddExperianceDataMutation();
  ...
  const onSubmit = async (values: any) => {
   ...
   // const data = JSON.stringify(obj);
    ...
    try {
      ...
      // console.log(formData)
      console.log(values)
        await addExperianceData(values);
