  ...
  console.log(data);
    ...
    },
    {
      ...
      render: function (data: any) {
        ...
        return (
          <>
            <Link href={`/user/project/details/${data}`}>
              <Button onClick={() => console.log(data)} type="primary">
                <EyeOutlined />
              </Button>
            </Link>
            <Link href={`/user/project/edit/${data}`}>
              <Button
                style={{
                  margin: "0px 5px",
                }}
  ...
  return (
    <div style={{ margin: '10px' }}>
     ...
     <EMTable
      ...
      >
        <p className="my-5">Do you want to remove this Project?</p>
      </EMModal>
    </div>
  );
};
