...
const ServicePage = () => {
  ...
  const { data, isLoading } = useFrameworksQuery({ ...query });
  const services = data?.frameworks;
  ...
  console.log(data);
    ...
    },
    {
      ...
      render: function (data: any) {
        ...
        return (
          <>
            <Link href={`/user/framework/details/${data}`}>
              <Button onClick={() => console.log(data)} type="primary">
                <EyeOutlined />
              </Button>
            </Link>
            <Link href={`/user/framework/edit/${data}`}>
              <Button
                style={{
                  margin: "0px 5px",
                }}
  ...
  return (
    <div style={{ margin: '10px' }}>
      ...
      <ActionBar title="Category List">
        ...
        />
        <div>
          <Link href="/user/framework/create">
            <Button type="primary">Create Framework</Button>
          </Link>
     ...
     <EMTable
      ...
      >
        <p className="my-5">Do you want to remove this Framework?</p>
      </EMModal>
    </div>
  );
};
